  ...
  return (
    <>
      ...
      <div className={headercss.nav + " " + (intersection ? "" : headercss.navscrolled)}>
        ...
        <Link href={"/"} className={headercss.logodiv}>
          <img
            ...
            className={
              headercss.logo +
              " " +
              (intersection == false || burgerOpen ? headercss.logoscrolled : "")
            }
          ></img>
        </Link>
              ...
              <div key={index}>
                <nobr>
                  ...
                  >
                    ...
                    <div
                      className={
                        headercss.navlabelunderline +
                        " " +
                        (hoveringCount == index ? "" : headercss.navlabelunderlineclosed)
                      }
                    ></div>
                  </div>
                </nobr>
                ...
                <div
                  ...
                  className={
                    hoveringCount == index ? headercss.navsublabel : headercss.navsubclosed
                  }
                >
                      ...
                      return (
                        <div key={index}>
                          <Link href={`/${itemChildren.url}`} passHref>
                            <div className={headercss.navsubitems}>{itemChildren.title}</div>
                          </Link>
        ...
        {/*Burger Icon*/}
        <div
          className={headercss.burger + " " + (burgerOpen ? headercss.burgeropen : "")}
          onClick={toggleBurger}
        >
          <div
            className={
              headercss.burgermiddle + " " + (burgerOpen ? headercss.burgermiddleopen : "")
            }
          ></div>
        </div>
      </div>
            ...
            return (
              <div key={index}>
                ...
                <div
                  className={
                    index == subMenuCount
                      ? headercss.burgerMenuSubtitles
                      : headercss.burgerMenuSubtitlesHidden
                  }
                >
                  {item.attributes.children.data.map((itemChildren) => {
                    if (itemChildren.hide_from_header != true) {
                      return (
